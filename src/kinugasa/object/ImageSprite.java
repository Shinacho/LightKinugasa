...
public class ImageSprite extends BasicSprite {
	...
	public ImageSprite(float w, float h, KImage image) {
		this(0, 0, w, h, image);
	}
	...
	public ImageSprite clone() {
		...
		sprite.image = this.image.clone();
		//sprite.painter = this.painter.clone();
		return sprite;
	}

	@NewInstance
	public ImageSprite compositeOn(List<? extends Sprite> s) {
		ImageSprite r = clone();
		r.image.drawOnThisImage(s).setTo(r);
		return r;
	}

	@NewInstance
	public ImageSprite compositeOn(Sprite... s) {
		ImageSprite r = clone();
		r.image.drawOnThisImage(s).setTo(r);
		return r;
	}
	...
	@NewInstance
	public static ImageSprite composite(List<? extends Sprite> s) {
		KImage i = KImage.composite(s);
		return new ImageSprite(i.getWidth(), i.getHeight(), i);
	}

	@NewInstance
	public static ImageSprite composite(Sprite... s) {
		KImage i = KImage.composite(s);
		return new ImageSprite(i.getWidth(), i.getHeight(), i);
	}
