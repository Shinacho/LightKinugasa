...
/**
 * ScriptedActorEffect2.<br>
 *
 * @vesion 1.0.0 - 2025/10/07_21:23:51<br>
 * @author Shinacho.<br>
 */
public class ScriptedStatusEffect2<T extends ScriptFile>
//		extends ScriptedStatusEffect<T> 
{
//
//	public ScriptedStatusEffect2(T key, Actor tgt) {
//		this(key, tgt, ExpireMode.NON, TIME_NOT_USER, ManualCountMode.NON, TIME_NOT_USER);
//	}
//
//	public ScriptedStatusEffect2(T key, Actor tgt, ExpireMode mode, int time) {
//		this(key, tgt, mode, time, ManualCountMode.NON, TIME_NOT_USER);
//	}
//
//	public ScriptedStatusEffect2(T key, Actor tgt, ManualCountMode mode, int c) {
//		this(key, tgt, ExpireMode.NON, TIME_NOT_USER, mode, c);
//	}
//
//	public ScriptedStatusEffect2(T key, Actor tgt, ExpireMode em, int time, ManualCountMode mm, int c) {
//		super(key, tgt, em, time, mm, c);
//	}
//
//	public ScriptedStatusEffect2(T key, Object extendId, Actor tgt) {
//		this(key, extendId, tgt, ExpireMode.NON, TIME_NOT_USER, ManualCountMode.NON, TIME_NOT_USER);
//	}
//
//	public ScriptedStatusEffect2(T key, Object extendId, Actor tgt, ExpireMode mode, int time) {
//		this(key, extendId, tgt, mode, time, ManualCountMode.NON, TIME_NOT_USER);
//	}
//
//	public ScriptedStatusEffect2(T key, Object extendId, Actor tgt, ManualCountMode mode, int c) {
//		this(key, extendId, tgt, ExpireMode.NON, TIME_NOT_USER, mode, c);
//	}
//
//	public ScriptedStatusEffect2(T key, Object extendId, Actor tgt, ExpireMode em, int time, ManualCountMode mm, int c) {
...
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.TEXT2);
//		if (blk.isEmpty()) {
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.IM_DEAD2);
//		if (blk.isEmpty()) {
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.IM_RESURRECT2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
//		var sao = (StatusUpdateSAO) blk.getSao();
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.FM_WALK2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
//		var sao = (StatusUpdateSAO) blk.getSao();
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.GET_ITEM2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.DROP_ITEM2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
//		var sao = (ItemGetSAO) blk.getSao();
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.EQIP_ITEM2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.UNEQIP_ITEM2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
//		var sao = (ItemEqipSAO) blk.getSao();
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.ADD_CONDITION2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.REMOVE_CONDITION2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
//		var sao = (ConditionChangeScriptAccessObject) blk.getSao();
...
//		ScriptFile sf = asScript().load();
//		ScriptBlock blk = sf.getBlockOf(ScriptBlockType.EFFECT2);
//		if (blk.isEmpty()) {
//			return new StatusUpdateResult();
//		}
...
//		var r = asScript().load().has(ScriptBlockType.EFFECT2);
//		asScript().free();
//		return r;
//	}
