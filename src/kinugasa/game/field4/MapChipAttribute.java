 ...
 * @author Shinacho<br>
 */
public class MapChipAttribute implements ID {
	 ...
	 */
	public MapChipAttribute(String id, int encountBaseValue) {
		this.id = id;
	...
	public String toString() {
		return "MapChipAttribute{" + "name=" + id + ", encountBaseValue=" + encountBaseValue + '}';
	}
