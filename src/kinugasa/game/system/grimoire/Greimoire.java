...
package kinugasa.game.system.grimoire;

import java.io.File;
import kinugasa.game.DescSupport;
import kinugasa.game.VisibleNameIDInjector;
import kinugasa.game.system.Actionable;
...
/**
 * Script.<br>
 * @vesion 1.0.0 - 2025/08/13_14:57:14<br>
 * @author Shinacho.<br>
 */
public class Greimoire  extends BagItem{

	protected Greimoire(File f) {
		super(f);
	}
	@Override
